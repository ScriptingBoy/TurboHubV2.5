...
local Section = Tab:NewSection("Gui V4")
Section:UpdateSection("GhostTuber Gui Beta")
Section:NewLabel("JOJO SCRIPT HUB 1")
label:UpdateLabel("jojo script hub Unrelease")
Section:NewButton("ButtonText", "Gui V4", function()
...
for theme, color in pairs(themes) do
    Section:NewColorPicker(theme, "Change your theme "DarkTheme, color, function(color3)
